...
.PHONY: doctor dev-up dev-down logs ps config test test-python test-ui test-e2e eval-langextract benchmark-langextract verify-frontend verify-python verify-pre-commit verify-pre-push format-check format-write lint-frontend release-package
