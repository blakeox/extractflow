...
- **Data:** SQLite and `/data` paths are not migrated automatically; follow backup guidance in [PRODUCTION_ROADMAP.md](PRODUCTION_ROADMAP.md) (P2) before major upgrades.
