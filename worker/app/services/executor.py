...
def execute_extraction(
    ...
    extracted_fields = provider.extract(text, template, settings)

    extracted_fields = [
        validate_extracted_field(definition, result)
        for definition, result in zip(template.extracted_fields, extracted_fields, strict=False)
    ]
